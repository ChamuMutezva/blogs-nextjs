    ...
    <div className="max-w-lg mx-auto mt-10">
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 sm:p-8 shadow-sm">
        ...
        <form action={formAction} className="space-y-5">
          ...
          <div>
            <label htmlFor="author" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">
              Author
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="url" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">
              Article URL
            </label>
            <input
              type="url"
